                ...
                <div className="p-8 sm:p-12">
                    ...
                    <div className="space-y-8 text-gray-700 leading-relaxed">
                        <section>
                            ...
                            <p>
                                Welcome to aggregateDuka. By accessing or using our website and services, you agree to be bound by these Terms and Conditions.
                        ...
                        <section>
                            ...
                            <p>
                                aggregateDuka provides a price tracking service for products listed on Carrefour Kenya. You agree to use this service only for lawful purposes
                        ...
                        <section>
                            ...
                            <p>
                                While we strive to provide accurate and up-to-date price information, we cannot guarantee the real-time accuracy of prices displayed on aggregateDuka.
                        ...
                        <section>
                            ...
                            <p>
                                The content, features, and functionality of aggregateDuka are and will remain the exclusive property of aggregateDuka and its licensors.
                                Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of aggregateDuka.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                In no event shall aggregateDuka, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental,
